...
def run(dbname="game.db"):
    ...
    sql_values_4 = (1, '1', '1', 1, '1,2', 1, time.time())
    sql_values_5 = (1, '1', '1', 2, '1,2', 1, time.time())
    ...
    sql_values_9 = (2, '1', 'START', 2, '3,2', 1, 0.0)
    sql_values_10 = (3, '1', 'START', 1, '1,3', 1, 0.0)
    sql_values_11 = (3, '1', 'WIN - ME', 1, '1,3', 1, 0.0)
